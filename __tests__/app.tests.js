...
describe("nc news app", () => {
  ...
  describe("GET /api/articles (pagination)", () => {
    ...
    test("status: 200, responds with the correct number of articles when limit is specified", () => {
      return request(app)
    ...
    test("status: 200, responds with the correct page of articles when p is specified", () => {
      return request(app)
    ...
    test("status: 200, responds with the correct number of articles when p and limit are specified", () => {
      return request(app)
        .get("/api/articles?sort_by=article_id&limit=3&p=3")
        .expect(200)
        .then(({ body }) => {
          expect(body.articles.length).toBe(3);
          expect(body.articles[0].article_id).toBe(7);
          expect(body.articles[1].article_id).toBe(8);
          expect(body.articles[2].article_id).toBe(9);
        });
    });
    test("status: 200, responds with the correct total_count when filters are applied", () => {
      return request(app)
        .get("/api/articles?topic=mitch")
        .expect(200)
        .then(({ body }) => {
    ...
    test("status: 400, responds with an error message if the limit is an invalid query", () => {
      return request(app)
    ...
    test("status: 400, responds with an error message if the p is an invalid query", () => {
      return request(app)
    ...
    test("status: 404, responds with an error message for out of bonds p query", () => {
      return request(app)
  ...
  describe("GET /api/articles/:article_id/comments PAGINATION", () => {
    test("status: 200, responds with an object containing a key of 'comments' and a value of an array of objects with the length of 10 by default", () => {
      return request(app)
        .get("/api/articles/1/comments")
        .expect(200)
        .then(({ body }) => {
    ...
    test("status: 200, responds with the correct number of comments when limit is specified", () => {
      return request(app)
    ...
    test("status: 200, responds with the correct page of comments when p is specified", () => {
      return request(app)
    ...
    test("status: 200, responds with the correct number of comments when p and limit are specified", () => {
      return request(app)
    ...
    test("status: 200, responds with the correct total_count", () => {
      return request(app)
        .get("/api/articles/1/comments")
        .expect(200)
        .then(({ body }) => {
